...
export const MEDICAL_PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    responseA: `Physical activity recommendations during therapeutic intervention must account for treatment-specific contraindications, physiological impact of the condition on exercise capacity, medication effects on cardiovascular and musculoskeletal response to exertion, and individualized risk-benefit assessment. Graduated return-to-activity protocols are preferable to abrupt resumption of pre-illness activity levels to minimize adverse events. [continues 255 more words]`,
...
export const FINANCIAL_PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    responseA: `Optimal retirement distribution strategy requires analysis of Required Minimum Distribution schedules under IRC provisions, Roth conversion opportunities during low-income years, Social Security benefit optimization through delay strategies, Medicare premium surcharge thresholds, tax bracket management across multiple income sources, and longevity risk considerations in withdrawal rate determination. [continues 280 more words]`,
  ...
  },
  {
    ...
    responseA: `Life insurance needs analysis employs multiple methodologies including the DIME approach encompassing debt obligations, income replacement calculations, mortgage balance, and education funding requirements. Human life value methodology estimates the present value of future earnings. Needs-based analysis quantifies specific financial obligations against existing assets and survivor income streams to determine appropriate coverage levels. [continues 262 more words]`,
  ...
  },
  {
    ...
    responseA: `The Roth versus traditional IRA decision involves comparative analysis of current marginal tax rate against projected retirement tax rate, consideration of RMD elimination advantages of Roth accounts, estate planning implications, state tax treatment variations, income eligibility thresholds for direct Roth contributions, and backdoor Roth conversion availability for high-income individuals. [continues 268 more words]`,
...
export const CS_PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    responseA: `Product return and refund processing is governed by our return policy which specifies eligible return windows, condition requirements for returned merchandise, and refund disbursement methodologies. Initiating a return requires accessing the returns portal through your account dashboard and following the prescribed procedural steps to generate a return merchandise authorization. [continues 238 more words]`,
  ...
  },
  {
    ...
    responseA: `Account information modification including personal data updates and credential management can be accomplished through the Account Settings section of your user profile. Password reset functionality is available through the authentication portal's password recovery workflow, which initiates a verification process through your registered email address. [continues 232 more words]`,
  ...
  },
  {
    ...
    responseA: `Promotional code application requires entry of the alphanumeric code in the designated promotional code field during the checkout process prior to order submission. Promotional offers are subject to eligibility requirements, expiration dates, and exclusion criteria as specified in the promotional terms and conditions. Retroactive application to completed transactions is generally not supported. [continues 240 more words]`,
...
export const EDUCATION_PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    responseA: `Differentiation between related conceptual constructs requires examination of their definitional boundaries, identifying both shared characteristics and distinguishing attributes. A comparative analysis should consider the contexts in which each concept applies, the theoretical frameworks that inform each, and practical applications that exemplify each concept distinctly to avoid conflation of related ideas. [continues 260 more words]`,
  ...
  },
  {
    ...
    responseA: `Real-world applications of theoretical concepts facilitate contextual understanding and demonstrate practical relevance of academic subject matter. Applied examples illustrating the translation of abstract principles to concrete scenarios enhance conceptual comprehension and support motivation through demonstration of the practical utility of theoretical knowledge. [continues 248 more words]`,
  ...
  },
  {
    ...
    responseA: `Chapter synthesis requires identification of primary learning objectives as specified in course documentation, key conceptual frameworks and their defining characteristics, significant methodologies or procedures introduced, critical vocabulary and terminology, and landmark examples or case studies that exemplify core principles constituting the essential knowledge base for subsequent assessment. [continues 258 more words]`,
...
export const DEVELOPER_PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    responseA: `Base model selection for reward model training involves consideration of parameter count relative to available computational resources, pre-training data characteristics and alignment with target domain, architectural properties affecting fine-tuning stability, and licensing constraints for production deployment. Reward model performance generally scales with parameter count, though efficient fine-tuning techniques can partially compensate for smaller model capacity. [continues 268 more words]`,
  ...
  },
  {
    ...
    responseA: `Loss curve interpretation during reward model training requires analysis of both training and validation loss trajectories across training steps. Monotonically decreasing training loss concurrent with stable or improving validation loss indicates appropriate learning dynamics. Divergence between training and validation curves suggests overfitting, while absence of loss reduction may indicate suboptimal learning rate selection or data quality issues. [continues 260 more words]`,

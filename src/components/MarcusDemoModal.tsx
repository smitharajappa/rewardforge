...
const STEPS = ['Upload', 'Annotate', 'Train RM', 'RL Loop', 'Evaluate'];
        ...
        >
          ...
          >
            ...
            <p className="text-center text-[14px] leading-[1.7] mb-5" style={{ color: '#a3a3a3' }}>
              Marcus uploads Chen & Associates' client FAQ, extracts his actual client questions, annotates AI responses with his team, trains a reward model, and exports a compliance-certified aligned legal AI — in under 6 hours.
            </p>

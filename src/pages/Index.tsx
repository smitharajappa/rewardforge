...
const FEATURES = [
  ...
  { icon: Sparkles, color: '#a78bfa', title: 'AI Copilot', desc: 'Ask anything about your training run in plain English. Instant answers about RM accuracy, algorithm choice, and pipeline optimisation. Works offline — always available.' },
